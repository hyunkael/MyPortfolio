...
:::{grid-item-card}
:link: blog-posts/index
:link-type: doc
:class-header: bg-light

📝 **Blog Posts**
^^^
Narrative-style notebooks that pair story-driven insights with runnable experiments.
:::
...
- **Blog Posts**: Long-form notebook write-ups that translate experiments into insights
